 ...
 */
class Emploi extends \projetBundle\Entity\Emploi implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'projetBundle\\Entity\\Emploi' . "\0" . 'id', '' . "\0" . 'projetBundle\\Entity\\Emploi' . "\0" . 'groupe');
        }
