 ...
 */
class PageRegistre extends \projetBundle\Entity\PageRegistre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'projetBundle\\Entity\\PageRegistre' . "\0" . 'id', '' . "\0" . 'projetBundle\\Entity\\PageRegistre' . "\0" . 'registre', '' . "\0" . 'projetBundle\\Entity\\PageRegistre' . "\0" . 'eleve', '' . "\0" . 'projetBundle\\Entity\\PageRegistre' . "\0" . 'matiere', '' . "\0" . 'projetBundle\\Entity\\PageRegistre' . "\0" . 'horaireAbsence', '' . "\0" . 'projetBundle\\Entity\\PageRegistre' . "\0" . 'dateAbsence', '' . "\0" . 'projetBundle\\Entity\\PageRegistre' . "\0" . 'etat');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageRegistre $proxy) {
    ...
    public function getHoraireAbsence()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHoraireAbsence', array());

        return parent::getHoraireAbsence();
    }
    ...
    public function setHoraireAbsence($horaireAbsence)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHoraireAbsence', array($horaireAbsence));

        return parent::setHoraireAbsence($horaireAbsence);
    }
