 ...
 */
class Registre extends \projetBundle\Entity\Registre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'projetBundle\\Entity\\Registre' . "\0" . 'id', '' . "\0" . 'projetBundle\\Entity\\Registre' . "\0" . 'groupe');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Registre $proxy) {
