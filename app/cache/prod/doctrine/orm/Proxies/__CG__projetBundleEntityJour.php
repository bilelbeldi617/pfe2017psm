 ...
 */
class Jour extends \projetBundle\Entity\Jour implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'projetBundle\\Entity\\Jour' . "\0" . 'id', '' . "\0" . 'projetBundle\\Entity\\Jour' . "\0" . 'emploi', '' . "\0" . 'projetBundle\\Entity\\Jour' . "\0" . 'nomJour', '' . "\0" . 'projetBundle\\Entity\\Jour' . "\0" . 'horaire');
        }
    ...
    public function setNomJour($nomJour)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomJour', array($nomJour));

        return parent::setNomJour($nomJour);
    }
    ...
    public function getNomJour()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNomJour', array());

        return parent::getNomJour();
    }
